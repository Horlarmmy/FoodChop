import { features, howItWorks } from '../contants'
    ...
    <div className='padding-x py-6'>
        ...
        <div className='grid grid-cols-1 gap-6  text-primary text-center'>
            {howItWorks.map((feature)=>{
                return(
                    <div key={feature.icon} className='flex flex-col gap-1 border-primary border-2 rounded-lg items-center p-5  hover:bg-secondary hover:text-white-200'>
                        <img src={feature.icon} alt="" width={60} height={60} />
